export default {
  route: {
    ...
    ListVendor: 'قائمة العملاء و الموردين',
    PonitOfSale: 'نقاط البيع',
    NewSaleInvoice: 'انشاء فاتورة بيع',
    EditSaleInvoice: 'تعديل فاتورة بيع',
    ...
    NewOrderInventory: 'سند مخزون جديد',
    EditOrderInventory: 'تعديل سند مخزون',
    Inventories: 'مخازن',
    ...
    EditVendor: 'تعديل عميل أو مورد',
    Visits: 'الزيارات',
    NewVisit: 'زيارة جديدة',
    EditVisit: 'تعديل زيارة',
    ...
    NewSalarySlip: 'وصل الراتب جديد',
    EditSalarySlip: 'تعديل وصل الراتب',
  ...
  PanelGroup: {
    ...
    MembershipmentOrdar: 'طلبات التجميد و اضافي',
    MemberList: 'قائمة',
    Messages: 'الرسائل',
  ...
  Members: {
    ...
    SendBy: 'إرسال عبر',
    Export: 'إستخراج',
    ExportDataOfMembers: "إستخراج جميع البيانات",
