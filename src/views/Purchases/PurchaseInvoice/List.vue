<template>
  <div class="app-container">
    ...
    <el-col :span="24">
      <Radio-Oprations TableName="PurchaseInvoice" @Set="
        (v) => {
          listQuery.Status = v;
          handleFilter();
        }
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%"
      ...
      <el-table-column v-bind:label="$t('CashPool.AccountInvoiceNumber')" width="120" align="center"
        prop="AccountInvoiceNumber"></el-table-column>
      ...
      <el-table-column width="180" align="center">
        <template slot-scope="scope">
          <Next-Oprations :ObjId="scope.row.Id" :Status="scope.row.Status" TableName="PurchaseInvoice"
            @Done="handleFilter" />
...
export default {
  ...
  data() {
    return {
      ...
      listLoading: false,
      listQuery: JSON.parse(localStorage.getItem('PurchaseInvoice_ListQuery') || null) || {
        Page: 1,
        Any: "",
  ...
  methods: {
    getList() {
      ...
      GetByListQ(this.listQuery).then((response) => {
        ...
        localStorage.setItem('PurchaseInvoice_ListQuery', JSON.stringify(this.listQuery))
