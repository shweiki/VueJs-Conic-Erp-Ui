            ...
            <el-table-column align="center" label="الاصناف \ المواد">
              <el-table-column prop="ItemsId" align="center">
                <template slot="header" slot-scope="{}"
                  >{{ props.row.Barcode == null ? "رقم" : "رقم \ باركود الصنف" }} ({{
                    props.row.InventoryMovements.length
                  }})</template
                >
                <template slot-scope="scope">
                  {{ scope.row.ItemsId }}
                  {{ scope.row.Barcode == null ? "" : " - " + scope.row.Barcode }}
                </template>
              </el-table-column>
              <el-table-column
              ...
              <el-table-column
                v-bind:label="$t('CashPool.Price') + ' شراء'"
                align="center"
              >
                <template slot-scope="scope">{{
              ...
              <el-table-column
                v-bind:label="$t('NewPurchaseInvoice.TotalJD')"
                align="center"
              >
                <template slot-scope="scope">{{
                  (scope.row.SellingPrice * scope.row.Total).toFixed(
                ...
                <template slot-scope="props">
                  ...
                  >
                    <el-table-column align="center" label="فواتير بيع">
                      ...
                      <el-table-column
                        v-bind:label="$t('CashPool.Price') + ' بيع'"
                        align="center"
                      >
                        <template slot-scope="scope">{{
                          scope.row.SellingPrice.toFixed($store.getters.settings.ToFixed)
                      ...
                      <el-table-column label="الباقي" align="center">
                        <template slot-scope="props"
                          >{{ props.row.Total.toFixed($store.getters.settings.ToFixed) }}
                        </template>
                      </el-table-column>
                      <el-table-column label="#" align="center">
                        <template slot-scope="scope">
