  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column
          prop="Description"
          :label="$t('Stocks.BondType')"
          align="center"
        />
        <el-table-column :label="$t('Stocks.Status')" width="120" align="center">
          <template slot-scope="scope">
            <Status-Tag :status="scope.row.Status" table-name="StockItem" />
          </template>
        </el-table-column>
        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-table :data="props.row.StockMovements">
              <el-table-column
                prop="Barcode"
                :label="$t('Stocks.Barcode')"
                width="130"
              />
              <el-table-column
                prop="Name"
                :label="$t('Stocks.Items')"
                width="130"
              />
              <el-table-column
                prop="Qty"
              ...
              <el-table-column
                prop="InventoryName"
                :label="$t('Stocks.Store')"
              />
              <el-table-column
                prop="Description"
                :label="$t('Stocks.Description')"
              />
            </el-table>
          </template>
        </el-table-column>
