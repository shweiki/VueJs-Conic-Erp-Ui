<template>
  <div id="list-complete-demo" class="demo" style="text-align-last: center;">
    ...
    <el-card class="box-card">
      <el-button class="pan-btn gray-btn" v-on:click="filter('Accounting')">{{
        $t("Report.Accounting")
      }}</el-button>
      <el-button class="pan-btn yellow-btn" v-on:click="filter('S&P')">{{
        $t("Report.Salesand")
      }}</el-button>
      <el-button class="pan-btn pink-btn" v-on:click="filter('Inventory')">{{
        $t("Report.Inventory")
      }}</el-button>
      <el-button
        class="pan-btn green-btn"
        v-on:click="filter('Classifications')"
        >{{ $t("Report.Classification") }}</el-button
      >
      <el-button class="pan-btn blue-btn" v-on:click="filter('all')">{{
        $t("Report.All")
      }}</el-button>
    </el-card>
    <el-card class="box-card" style="margin-bottom:50px;">
      ...
      >
        ...
        >
          <el-button
            @click="windowopen(item.link, item.name)"
            :class="item.class"
