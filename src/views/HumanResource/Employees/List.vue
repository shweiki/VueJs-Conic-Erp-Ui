  ...
  <div class="app-container">
    <el-card class="box-card">
      ...
      <el-row type="flex">
        ...
        <el-col :span="3">
          <SortOptions :Value="listQuery.Sort" @Set="
            (v) => {
              listQuery.Sort = v;
              handleFilter();
            }
        ...
        <el-col :span="6">
          <RadioOprations TableName="Employee" :default="listQuery.Status" @Set="
            (v) => {
              listQuery.Status = v;
              handleFilter();
            }
    ...
    <el-table v-loading="listLoading" :data="list" border fit height="400" highlight-current-row style="width: 100%"
      ...
      <el-table-column v-bind:label="$t('Members.Phone1')" prop="PhoneNumber1" width="110"></el-table-column>
      ...
      <el-table-column width="180" align="center">
        <template slot-scope="scope">
          <Next-Oprations :ObjId="scope.row.Id" :Status="scope.row.Status" TableName="Employee" @Done="handleFilter" />
...
export default {
  ...
  data() {
    return {
      ...
      Selection: [],
      SmsBody: "",
      listQuery: JSON.parse(Cookies.get('Employee_ListQuery') || null) || {
        Page: 1,
        Any: "",
  ...
  methods: {
    ...
    getList() {
      ...
      GetByListQ(this.listQuery).then((response) => {
        ...
        Cookies.set('Employee_ListQuery', JSON.stringify(this.listQuery))
