  ...
  <el-row :gutter="20" class="panel-group" style="margin: 20px 2px">
    <el-col v-if="Shows.MembersActive" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('MembersActive')">
        <div @dblclick="$router.push({ path: `/Gym/MembersLogs` })" class="card-panel-icon-wrapper icon-people">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="Totals.MembersActive" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    ...
    <el-col v-if="Shows.MsgCredit" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('MsgCredit')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="Totals.MsgCredit" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col v-if="Shows.Members" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('Members')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="Totals.Members" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col v-if="Shows.Items" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('Items')">
        <div @dblclick="$router.push({ path: `/Item` })" class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="peoples" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">{{ $t("PanelGroup.Items") }}</div>
          <count-to :start-val="0" :end-val="Totals.Items" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col v-if="Shows.Clients" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('Clients')">
        <div @dblclick="$router.push({ path: `/Vendor/ListVendor` })" class="card-panel-icon-wrapper icon-people">
          <svg-icon icon-class="peoples" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
    ...
    <el-col v-if="Shows.Purchases" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('Purchases')">
        <div @dblclick="$router.push({ path: `/Purchases` })" class="card-panel-icon-wrapper icon-money">
    ...
    <el-col v-if="Shows.Sales" :xs="6" :sm="6" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('Sales')">
        <div @dblclick="$router.push({ path: `/Sales` })" class="card-panel-icon-wrapper icon-shopping">
          <svg-icon icon-class="shopping" class-name="card-panel-icon" />
        </div>
        <div class="card-panel-description">
          <div class="card-panel-text">{{ $t("PanelGroup.Sales") }}</div>
          <count-to :start-val="0" :end-val="Totals.Sales.Count" :duration="3600" class="card-panel-num" />
        </div>
      </div>
